...
export const SOURCE_CAPABILITIES = Object.freeze({
  ...
  hentaigasm: { genreFilter: true, tagFilter: true, catalogScopedSearch: true },
  mangadistrict: { genreFilter: true, catalogScopedSearch: true },
  manhwaread: { genreFilter: true, tagFilter: true, catalogScopedSearch: true },
