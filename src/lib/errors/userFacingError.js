...
function isCloudflareBlockedMessage(message = "") {
  return /cloudflare|cf-chl|just a moment|checking your browser|attention required|حماية.*تمنع|proxy Night-Novel|Challenge non résolu|bad gateway|surchargé|Trop de requêtes FlareSolverr|Chrome a planté/i.test(message);
}
