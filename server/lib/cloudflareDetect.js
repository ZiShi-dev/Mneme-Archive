...
const CONTENT_MARKERS = /novel-item|novel-list|page-item-detail|wp-manga|manga-item|bg-card|data-wor-library|wor-library|wor-single-novel|wor-reader|epcontent|reading-content|text-chapter|ts-post-image|<article\b|chapterData|chaptersList|chapter-item|chapter-heading|Genre Index|Tag Index|manga-titles|manga-desc|mov clearfix|mov-t|server-item|eplist|blocfr|blocvostfr|wiflix/i;
